...
def get_student_profile(
    ...
    return {
        ...
        "attitudeDetail": {
            "score": computed.attitude_score,
            "attendanceRate": computed.attendance_rate,
            "attendanceScore": computed.attendance_score,
            "participationRate": computed.participation_rate,
            "interactionCount": computed.interaction_count,
            "interactionScore": computed.interaction_score,
            "homeworkRate": computed.homework_rate,
            "homeworkScore": computed.homework_score,
            "weights": {
                "attendance": computed.w_attendance,
                "interaction": computed.w_interaction,
                "homework": computed.w_homework,
            },
        },
