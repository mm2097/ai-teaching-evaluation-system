...
export const menuList: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/analysis/ct-achievement', title: '课程目标达成度', icon: 'Aim' },
    ],
  },
  // ---- 学生端分析 ----
  {
...
export const routeTitleMap: Record<string, string> = {
  ...
  '/analysis/ct-achievement': '课程目标达成度',
  '/quiz/bank': '题库管理',
  '/quiz/manage': 'AI 出题',
  '/quiz/records': '答题记录',
  '/quiz/answer': '在线答题',
...
export const routeParentMap: Record<string, { path: string; title: string }> = {
  ...
  '/student/quiz-list': { path: '/quiz', title: '数智化教学分析评价' },
  '/student/practice-records': { path: '/quiz', title: '数智化教学分析评价' },
  '/student/quiz-result': { path: '/quiz', title: '数智化教学分析评价' },
